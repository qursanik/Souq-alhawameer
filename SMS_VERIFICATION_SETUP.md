...
Firebase تقدم حصة مجانية محدودة من الرسائل النصية:
- الحصة المجانية محدودة جداً وقد تتغير (راجع [صفحة الأسعار](https://firebase.google.com/pricing) للتفاصيل الحالية)
- يُنصح بالترقية لخطة Blaze (الدفع حسب الاستخدام) للاستخدام في الإنتاج
- **ملاحظة:** الحصص المجانية تخضع للتغيير من قبل Firebase، تحقق من الوثائق الرسمية للحصول على أحدث المعلومات
